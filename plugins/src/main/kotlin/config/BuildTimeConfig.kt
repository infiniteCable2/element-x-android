...
object BuildTimeConfig {
    const val APPLICATION_ID = "io.github.infinitecable2.elementx"
    const val APPLICATION_NAME = "InfiniteCable2 Matrix"
    val METADATA_HOST_REVERSED: String? = "io.github.infinitecable2.elementx"
